package com.starter_kits_usmb.back_java_spring_boot.answer.dao;
...
public class AnswerDAO {
    ...
    public static AnswerDAO fromAnswer(Answer answer) {
        ...
        answerDAO.setQuestion(answer.getQuestion().getId());
        return answerDAO;
    }
